# Turkish Stemmer for .NET/CSharp
...
1. Fork it ( `http://github.com/<my-github-username>/turkish-stemmer-csharp/fork` )
...
turkishstemmer-csharp is licensed under the Apache Software License, Version 2.0.